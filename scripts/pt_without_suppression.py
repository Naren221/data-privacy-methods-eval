...
def visualize_comparison(comparison, sensitive_attributes):
    ...
    plt.tight_layout()
    plt.savefig('C:/Users/naren/OneDrive/Documents/CMI/Semester 4/Data Quality and Data Privacy/data-privacy-methods-eval/images/privacy_comparison_with_risk.png')
    plt.close()
...
def main():
    # Load data
    file_path = "C:/Users/naren/OneDrive/Documents/CMI/Semester 4/Data Quality and Data Privacy/data-privacy-methods-eval/data/bank.csv"  # Change to your file path
    ...
    k_anonymized_df.to_csv("C:/Users/naren/OneDrive/Documents/CMI/Semester 4/Data Quality and Data Privacy/data-privacy-methods-eval/output/k_anonymized_data.csv", index=False)
    l_diversified_df.to_csv("C:/Users/naren/OneDrive/Documents/CMI/Semester 4/Data Quality and Data Privacy/data-privacy-methods-eval/output/l_diversified_data.csv", index=False)
